...
static unsigned int gpioLED = 44;       ///< hard coding the LED gpio for this example to P8_12 (GPIO44)
static unsigned int gpioLED2 = 26;	///P8_14
static unsigned int gpioButton = 45;   ///< hard coding the button gpio for this example to P8_11 (GPIO115)
static unsigned int gpioButton2 = 27;	///P8_17
